...
<div id="category-app">
  ...
  <div class="toolbar">
    <div class="filter-group">
      ...
      <button class="filter-btn" data-tag="朝鉴">朝鉴</button>
      <button class="filter-btn" data-tag="趋势洞察">趋势洞察</button>
      <button class="filter-btn" data-tag="新闻">新闻</button>
    </div>
...
(function() {
  ...
  async function loadPosts() {
    try {
      ...
      allPosts = meta.filter(p => p.category === 'zhaojian');
